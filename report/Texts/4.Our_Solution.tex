...
\todo[inline]{JT: In the Nym ecosystem, who are the TTPs, who operates them, what exactly are they trusted for?}
...
\end{equation}
\todo[inline]{Take a look if a schema could be interesting to illustrate Eq. \ref{eq:shared_secret}}
...
\label{eq:layer_i}
\end{equation}
\todo[inline,color=purple!30]{$\B{i+1}{1}$ is a light notation for $\B{(i+1,}{1)}$, should I put the full notation for clarity ?}
