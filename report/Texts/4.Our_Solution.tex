...
Our approach to ensure trust in the Sphinx header is to prevent user manipulation by decentralizing the header construction to Trusted Third Parties (TTPs) through the use of Multi-Party Computation (MPC).
\newline
...
\todo[inline, color=green]{Better in 'model' section or here (since it's an assomption to have lighter math formula)}
...
\begin{figure}
    ...
    \label{fig:overall_schema}
\end{figure}
\todo{Caption: expand TTP, name (1) to (5)}
