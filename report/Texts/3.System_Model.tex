...
observers to link incoming and outgoing messages just by observing packets length. The
...
\todo[inline]{Aurelien: I feel like the bullet points are mixing a bit threat model (GPA, malicious user and honest-but-curious TTP) with desired properties (collusion resistant, integrity, unlinkability, ...)}
\begin{itemize}
...
%
\end{itemize}
\todo[inline]{Some objectives may need a bit of explanation re. why they matter,
