...
Although modest (less than 50 ms in our evaluation) compared with the end-to-end latency of decentralized networks such as the Lightening Network and mixnets, these costs should be considered in latency-sensitive settings.
