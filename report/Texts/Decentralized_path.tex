...
\subsubsection{Integration with Decentralized Header Construction}\todo{In future work}

As illustrated in Fig.~\ref{}
%\todo{figure}
, combining decentralized path sampling with decentralized header construction currently requires two rounds of interaction between the client and the STTPs.
