...
\end{comment}
In order to prevent such as biased routing and $(N-1)$ attacks, our protcol should be accompanied by a scheme where the STTP choose the path instead of the client.
...
To sample a routing path, the client sends a nonce $w$ (a randomness seed)to a set of $n$ STTPs. 
