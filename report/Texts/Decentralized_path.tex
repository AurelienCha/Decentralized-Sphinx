...
For each hop $i$, the corresponding scalar secret is obtained by multiplying the reconstructed point with the secrets of the previous hops and mapping the result back to the scalar field:
\begin{equation}
...
\subsubsection{Integration with Decentralized Header Construction (TODO)}
