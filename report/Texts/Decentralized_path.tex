...
Upon receiving a nonce from the client, the STTPs collaboratively sample a path in a pseudorandom manner and return shares of the corresponding secret materials. 
