...
Although the Lightning Network was initially introduced to address Bitcoin's scalability issues, it also mitigates some of the privacy issues inherent to peer-to-peer networks~\cite{sharma2022anonymity}. 
In particular, its onion-routing mechanism is designed to prevent intermediate nodes from identifying both the sender and receiver of a transaction.
