...
These privacy guarantees, both in mixnets and in the Lightening Network, are achieved using the Sphinx packet format~\cite{sphinx}.
...
Second, Sphinx provides \emph{per-hop integrity protection} through a cryptographic tag embedded in each layer of the header. These tags prevent adversaries from tampering with routing information.  Any modification results in an integrity-tag verification failure at the mixnode, causing the packet to be discarded.
...
To the best of our knowledge, this is the work that address these limitations by proposing a mechanism that decentralize the construction of the Sphinx packet format.
