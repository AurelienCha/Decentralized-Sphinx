...
A malicious client can intentionally bias route selection, thereby reducing the network-privacy of honest clients, or even orchestrate an (N-1)-attacks to trace packets~\cite{wright03}. In Lightening Networks a malicious client can route through long, winding paths specifically to launch jamming attack and/or freeze funds stay for longer.
\todo{iness: cite }
\begin{comment}
...
To the best of our knowledge, this is the first work that address malicious clients in privacy-networks by proposing a decentralized construction of the Sphinx packet format.
