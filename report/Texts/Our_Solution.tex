\section{Our Solution}\label{sec:scheme}
\subsection{Sphinx}
\todo{Iness: This entire subsection explains the original sphinx packet format, I think it's too much and can be reduced to 20\%. The rest can be eithger be deleted or used on how you construct the decentralized scheme}
...
\todo{Iness: Is there a reason why the arrows have different colors? If not than change to all black, Change "App" with "Service provider", Also I prefer a white background over black}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Images/sphinx\_ttp.png}
