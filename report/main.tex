...
\acmConference[WPES ’25]{Make sure to enter the correct
  conference title from your rights confirmation email}{October 13--17,
  2025}{Taipei, Taiwan}
%%
...
\title[Decentralized Sphinx Header Construction]{Towards Decentralized Sphinx Header Construction}
...
%% article.
\begin{abstract}
  \todo[color=green, inline]{To adapt}
