...
\begin{tikzpicture}
    ...
    \begin{pgfonlayer}{background}
        % Phi
        \foreach \j in {1,...,6} {
            \draw[->, dashed, very thin, color=unHighlight!80] ([xshift=\j*\width-0.5*\width] phi.south west) -- ([xshift=\j*\width, yshift=+1pt] ip.north);
        }
        % 3
        \foreach \j in {1,...,5} {
    ...
    %     ([xshift=4*\width] ip.north east) -- (B35.south east) node[midway, xshift=110pt]{Eq. \ref{eq:preprocessing}};
