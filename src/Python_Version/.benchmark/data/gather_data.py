...
print("\nGathering all CSV files...")
SHORT_NAME ={'p': 'PATH_LENGTH', 't': 'THRESHOLD', 'm': 'NBR_MIXNODES', 's': 'NBR_STTPS', 'c': 'NBR_CLIENTS'}
...
for file in csv_files:
    df = pd.read_csv(file, names=["timestamp", "entity", "entity_id", "direction", "DESTINATION", "DESTINATION_ID", "type", "Hash", "function", "CPU_time_ms", "wall_time_ms"])
