...
\newcommand{\sG}[2]{\inmath{s_\index{#1}\hspace{-0.2mm}G_\index{#2}}}
...
\tikzset{    
    % shape
    block/.style={minimum width = #1*\x, minimum height = 0.85*\y, inner sep = 0mm, anchor=west},%
    inblock/.style={minimum width = #1*\x - 0.16mm, minimum height = 0.85*\y - 0.35mm, xshift=0.08mm, inner sep = 0mm, anchor=west},
