...
\tikzset{    
    ...
    % Color
    p1/.style={inblock = #1, pattern = {Lines[angle=45, distance=3pt, line width=1pt, xshift=  0pt]}, pattern color = color1, opacity = 0.2},
    p2/.style={inblock = #1, pattern = {Lines[angle=45, distance=3pt, line width=1pt, xshift=1.5pt]}, pattern color = color2, opacity = 0.2},
    p3/.style={inblock = #1, pattern = {Lines[angle=45, distance=3pt, line width=1pt, xshift=  3pt]}, pattern color = color3, opacity = 0.2},
    c1/.style={inblock = #1,                                      fill = color1, opacity = 0.1},
    c2/.style={inblock = #1,                                      fill = color2, opacity = 0.1},
    c3/.style={inblock = #1,                                      fill = color3, opacity = 0.1},
