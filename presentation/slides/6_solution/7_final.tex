...
% HMAC
\at{B31}{-1}{1.4}               (salt3)                             {$(\s{3}, \sHashed{3})$};
...
\only<\thebeamerpausesplusONE->{
    ...
    \at{xor2}{-6}{1} (layeriFormula) [draw,anchor=base] {
        $\B{\i}{} \quad \left\{ \quad
        \begin{aligned}
            \B{\i}{1} &= \N{\hspace{0.5pt}i+1} &\hspace{-8pt}+\hspace{3pt} \sG{\hspace{0.5pt}i}{1} \\
            \B{\i}{2} &= \C{\hspace{0.5pt}i+1} &\hspace{-8pt}+\hspace{3pt} \sG{\hspace{0.5pt}i}{2} \\
            \B{\i}{3} &= \B{(i+1,}{1)} &\hspace{-8pt}+\hspace{3pt} \sG{\hspace{0.5pt}i}{3} \\
            \B{\i}{4} &= \B{(i+1,}{2)} &\hspace{-8pt}+\hspace{3pt} \sG{\hspace{0.5pt}i}{4} \\
            \B{\i}{5} &= \B{(i+1,}{3)} &\hspace{-8pt}+\hspace{3pt} \sG{\hspace{0.5pt}i}{5} \\
        \end{aligned}
        \right.$
    }; \node [eq] at (layeriFormula.north west) {4};

    \at{xor1}{-6}{1} (integrityFormula) [draw,anchor=base] {$\C{\i} = \sG{\hspace{0.5pt}i}{} + \sum_{j=1}^{5} \big( \hashIt{\sHashed{\i}}{j} \, \B{\i}{j} \big)$};
    \node [eq] at (integrityFormula.north west) {5};
}